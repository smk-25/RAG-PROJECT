...
with st.sidebar:
    ...
    if choice == "⚡ Simple QA (RAG)":
        ...
        with st.expander("Advanced Summary Tuning"):
            ...
            s_rpm = st.number_input("Target RPM", 1, 300, 30)  # Vertex AI supports much higher quotas
            s_batch = st.number_input("Batch size", 5, 100, 20)  # Process more chunks per call
